Public Class PRODUCT
    ...
    Private Sub btnsearch_Click(sender As Object, e As EventArgs) Handles btnsearch.Click
        ...
        Dim rc As Integer
        Dim rs As New ADODB.Recordset
        rs.Open("select * from PRODUCTS", con, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockBatchOptimistic)
    ...
    Private Sub dg_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg.CellClick
        txtcode.Text = dg.CurrentRow.Cells(0).Value
        cmbtype.Text = dg.CurrentRow.Cells(1).Value
        txtname.Text = dg.CurrentRow.Cells(2).Value
        cmbgst.Text = dg.CurrentRow.Cells(3).Value
    End Sub
